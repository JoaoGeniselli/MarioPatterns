...
//            }
    ...
    object RedMushroom : StateChangingItem() {
        ...
        override fun appearance(): Int = R.drawable.item_red_mushroom
    ...
    object FireFlower : StateChangingItem() {
        ...
        override fun appearance(): Int = R.drawable.item_flower
    ...
    object Feather : StateChangingItem() {
        ...
        override fun appearance(): Int = R.drawable.item_feather
    ...
    object Star : Item() {
        ...
        override fun appearance(): Int = R.drawable.item_star
    ...
    object GreenMushroom : Item() {
        ...
        override fun appearance(): Int = R.drawable.item_green_mushroom

        override fun applyTo(mario: Mario) = LifeSupply.addLives(1)
    }

    object YoshiEgg : Item() {

        override fun appearance(): Int = R.drawable.item_yoshi_egg
